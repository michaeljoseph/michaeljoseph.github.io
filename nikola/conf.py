...
BLOG_EMAIL = "michaeljoseph+mjgh@gmail.com"
BLOG_DESCRIPTION = "Mumbled ramblings and crossed streams of consciousness."
...
DEPLOY_COMMANDS = ['ghp-import output -r master -p']
